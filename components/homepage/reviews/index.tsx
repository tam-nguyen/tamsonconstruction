...
const Reviews = () => {
  const reviews = [
    ...
    },
    {
      ...
      name: "Emma W.",
      comment:
        "Excellent service! The plumber arrived on time and quickly fixed the plumbing issue in my kitchen. Highly recommended!",
      date: "April 1, 2022",
    },
    {
      img: mike,
      name: "Mike R.",
      comment:
        "Very professional and efficient. The handyman did a great job installing shelves in my living room. I'm impressed!",
      date: "April 1, 2022",
    },
    {
      img: michelle,
      name: "Michelle D.",
      comment:
        "I called the handyman for some electrical repairs, and he did an outstanding job. Courteous, knowledgeable, and reasonably priced.",
      date: "April 1, 2022",
    },
  ];
      ...
      <Swiper
        ...
        {reviews.map(({ img, name, comment, date }) => {
          return (
            <SwiperSlide
              key={name}
              className="space-y-1 rounded-lg max-w-[260px] max-h-[320px]">
              <div className="h-full w-full flex flex-col justify-between items-center shadow-custom mx-auto p-3 rounded-2xl mt-3">
                ...
                <p className="font-sm font-normal ml-auto w-fit pr-3">
                  {" "}
                  {date}{" "}
                </p>
              </div>
